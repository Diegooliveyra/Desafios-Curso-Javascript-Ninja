...
*/
  ...
  var resultado = brasil.every(function (estado) {
...
*/
  ...
  var res = brasil.some(function (estado) {
    return estado == "Ceara";
  });
  console.log(res ? "Ceará está incluído!" : "Ceará não foi incluído :(");
...
*/
  ...
  /*
Mostre no console o arr[ay criado acima:
*/
